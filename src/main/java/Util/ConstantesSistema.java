...
public class ConstantesSistema {
	...
	public static final String ERRO_AO_REDIRECIONAR = "Erro ao Redirecionar Para a Página Principal!";
	...
	public static final String VERIFIQUE_O_TIPO_DO_TELEFONE_PREENCHIDO = "Verifique O Tipo Do Telefone Preenchido";
